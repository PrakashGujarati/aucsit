            ...
            <div class="single-hero-item set-bg" data-setbg="img/slider/bg-2.jpg">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                        <h4 style="color:white;margin-top:10px;">Organized by</h4>
                        <h2> Department of Computer Science & IT</span></h1>
                        <h4 style="color:white;">Atmiya University, Rajkot</h4>
                        <h5 style="color:white;margin-top:5px;">Contact : 90990 76151 / 52 / 53, Email: <a href="mailto:stavan.patel@atmiyauni.ac.in">stavan.patel@atmiyauni.ac.in</a></h5>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">                            
          ...
          <br/>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="tickets-table">
                        <div class="table-price text-center">
                            <h2 class="table-title"><img src="img/cyber1.png"></h2>
