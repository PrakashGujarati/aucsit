...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{asset('assets/horizontal/css/style.css')}}" rel="stylesheet">
    <!-- You can change the theme colors from here -->
    <link href="{{asset('assets/assets/css/colors/blue.css')}}" id="theme" rel="stylesheet">
...
<body class="fix-header fix-sidebar card-no-border logo-center">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="{{asset('assets/assets/images/users/3.jpg')}}" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
    ...
    <script src="{{asset('assets/horizontal/js/jquery.slimscroll.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{asset('assets/horizontal/js/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{asset('assets/horizontal/js/sidebarmenu.js')}}"></script>
    <!--stickey kit -->
    <script src="{{asset('assets/assets/plugins/sticky-kit-master/dist/sticky-kit.min.js')}}"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('assets/horizontal/js/custom.min.js')}}"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
    ...
    <!-- Chart JS -->
    <script src="{{asset('assets/horizontal/js/dashboard1.js')}}"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
